...
public:
	...
	virtual bool Collision(objectBase* _src, std::vector<objectBase*>* _dst, std::vector<Rect_<float>>* _dstSection = nullptr) = 0;
	virtual bool Collision(objectBase* _src, std::vector<objectBase*>* _dst, std::vector<Box_<float>>* _dstSection = nullptr) = 0;
