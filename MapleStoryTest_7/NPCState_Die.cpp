...
bool NPCState_Die::initialize()
{
	...
	FMODSound* pSoundHit = FMODSoundManager::getInstance()->getSound(L"Damage.mp3");
	pSoundHit->playEffect();

	FMODSound* pSoundDie = FMODSoundManager::getInstance()->getSound(L"Die.mp3");
	pSoundDie->playEffect();
