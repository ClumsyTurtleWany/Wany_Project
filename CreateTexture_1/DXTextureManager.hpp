...
{
private:
	static DXTextureManager* textureMgr;
...
public:
	static DXTextureManager* getTextureMgr()
	{
		if (textureMgr == nullptr)
		{
			textureMgr = new DXTextureManager;
		}
		return textureMgr;
	}
...
DXTextureManager* DXTextureManager::textureMgr = nullptr;
