...
UserState_Skill_0_2::UserState_Skill_0_2(Player* _user) : UserState(_user)
{
    initialize();
}

bool UserState_Skill_0_2::initialize()
{
    float x = 0.0f;
    float y = 0.0f;
    float width = 504;
...
bool UserState_Skill_0_2::frame()
{
    ...
    if (FPS >= 45)
    {
        ...
        else
        {
            ...
            {
                user->changeCurrentState<UserState_Skill_0_3>();
            }
...
bool UserState_Skill_0_2::render()
{
    skill->render();
...
bool UserState_Skill_0_2::release()
{
    return true;
}
