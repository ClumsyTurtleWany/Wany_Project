...
void DXTextureRenderTarget::setOldRTV(ID3D11RenderTargetView* _pRTV)
{
	m_pOldRenderTargetView = _pRTV;
}

void DXTextureRenderTarget::setOldDSV(ID3D11DepthStencilView* _pDSV)
{
	m_pOldDepthStencilView = _pDSV;
}

void DXTextureRenderTarget::setOldVP(D3D11_VIEWPORT _vp)
{
	m_OldViewPort[0] = _vp;
}
